    ...
    return (
      <div className="main_app">
        ...
        date={dates}
          ...
          title={restaurantList[0].data.cuisines}
          address={restaurantList[0].data.area}
        ></Notes>
  
        <Notes
          name={restaurantList[1].data.name}
          title={restaurantList[1].data.cuisines}
          address={restaurantList[1].data.area}
        ></Notes>

<Notes
          name={restaurantList[2].data.name}
          title={restaurantList[2].data.cuisines}
          address={restaurantList[2].data.area}
        ></Notes>
      </div>
    );
  };
...
const rootRendering2 = ReactDOM.createRoot(document.getElementById("root"));

rootRendering2.render(<JsxHeading />);
